...
function start() {
	...
	if (y == 3100 || y == 3110 || y == 3111 || y == 3112 || y == 2300 || y == 2310 || y == 2311 || y == 2312) {
		...
		im.gainItem(2430328, -1);
		im.getPlayer().changeSingleSkillLevel(Packages.client.SkillFactory.getSkill(y < 1000 ? 1130 : y < 2000 ? 10001130 : y < 2200 ? 20001130 : y < 2300 ? 20011130 : 30001130), 1, 1, im.getCurrentTime() + (90 * 24 * 60 * 60 * 1000));
